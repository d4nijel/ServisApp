...
{
    public class KlijentskiRacunDetaljiVM
    {
        [HiddenInput]
        ...
        [Remote(action: nameof(KlijentskiRacunController.ProvjeraEmailaKlijentskogRacuna), controller: "KlijentskiRacun", AdditionalFields = nameof(KlijentskiRacunId))]
